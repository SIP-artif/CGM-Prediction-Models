...
# Input layer
model.add(LSTM(128, activation='tanh', return_sequences=True, input_shape=(36, 5), kernel_regularizer=regularizers.l1_l2(l1=1e-6, l2=1e-5)))
model.add(Dropout(0.4))

#Second layer
model.add(Bidirectional(LSTM(64, activation='tanh', return_sequences=True, kernel_regularizer=regularizers.l1_l2(l1=1e-6, l2=1e-5))))
model.add(Dropout(0.4))

# Third layer
model.add(Bidirectional(LSTM(32, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=1e-6, l2=1e-5))))
model.add(Dropout(0.4))
...
def pred_ega(y_true, y_pred, glycemic_ranges=(40, 400)): #CHECK
    """
